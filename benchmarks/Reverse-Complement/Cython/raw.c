...
static int __pyx_m_clear(PyObject *m) {
  ...
  Py_CLEAR(clear_module_state->__pyx_n_s_rev_comp);
...
static int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  Py_VISIT(traverse_module_state->__pyx_n_s_rev_comp);
...
#define __pyx_n_s_rev_comp __pyx_mstate_global->__pyx_n_s_rev_comp
...
static unsigned char __pyx_f_3raw_complement(unsigned char __pyx_v_base) {
 ...
 */
  ...
  __Pyx_AddTraceback("raw.complement", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_v_dna_sequence = 0;
  #if !CYTHON_METH_FASTCALL
  ...
  {
    PyObject **__pyx_pyargnames[] = {&__pyx_n_s_dna_sequence,0};
    if (__pyx_kwds) {
      Py_ssize_t kw_args;
      switch (__pyx_nargs) {
      ...
      switch (__pyx_nargs) {
        case  0:
        if (likely((values[0] = __Pyx_GetKwValue_FASTCALL(__pyx_kwds, __pyx_kwvalues, __pyx_n_s_dna_sequence)) != 0)) {
    ...
    __pyx_v_dna_sequence = ((PyObject*)values[0]);
  }
  goto __pyx_L6_skip;
...
static PyObject *__pyx_pf_3raw_reverse_complement(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_dna_sequence) {
  Py_ssize_t __pyx_v_n;
  unsigned char *__pyx_v_rev_comp;
...
static int __Pyx_CreateStringTabAndInitStrings(void) {
  __Pyx_StringTabEntry __pyx_string_tab[] = {
    ...
    {&__pyx_n_s_rev_comp, __pyx_k_rev_comp, sizeof(__pyx_k_rev_comp), 0, 0, 1, 1},
