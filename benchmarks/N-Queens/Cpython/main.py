...
@measure_energy_to_csv(n=__default__["n-queens"]["test_n"], csv_filename="n_queens_cpython")
def run_energy_benchmark(n: int) -> None:
    main(n)

@measure_time_to_csv(n=__default__["n-queens"]["test_n"], csv_filename="n_queens_cpython")
