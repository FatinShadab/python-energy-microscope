...
@measure_time_to_csv(n=__default__["regex_redux"]["test_n"], csv_filename="regex_redux_ctypes")
...
@measure_energy_to_csv(n=__default__["regex_redux"]["test_n"], csv_filename="regex_redux_ctypes")
