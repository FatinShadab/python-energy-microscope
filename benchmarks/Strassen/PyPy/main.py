...
@measure_energy_to_csv(n=__default__["strassen"]["test_n"], csv_filename="strassen_pypy")
...
@measure_time_to_csv(n=__default__["strassen"]["test_n"], csv_filename="strassen_pypy")
