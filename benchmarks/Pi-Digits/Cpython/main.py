...
@measure_energy_to_csv(n=__default__["pi_digits"]["test_n"], csv_filename="pi_digits_cpython")
...
@measure_time_to_csv(n=__default__["pi_digits"]["test_n"], csv_filename="pi_digits_cpython")
