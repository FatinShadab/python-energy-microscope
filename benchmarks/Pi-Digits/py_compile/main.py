...
@measure_energy_to_csv(n=__default__["pi_digits"]["test_n"], csv_filename="pi_digits_pycompile")
...
@measure_time_to_csv(n=__default__["pi_digits"]["test_n"], csv_filename="pi_digits_pycompile")
