...
@measure_energy_to_csv(n=__default__["strassen"]["test_n"], csv_filename="spectral_norm_ctypes")
...
@measure_time_to_csv(n=__default__["strassen"]["test_n"], csv_filename="spectral_norm_ctypes")
