...
@measure_time_to_csv(n=__default__["nbody"]["test_n"], csv_filename="nbody_py_compile")
...
@measure_energy_to_csv(n=__default__["nbody"]["test_n"], csv_filename="nbody_py_compile")
